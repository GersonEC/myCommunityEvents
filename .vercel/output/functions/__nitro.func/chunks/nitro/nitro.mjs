...
import { createFileRoute, lazyRouteComponent, defaultTransformer, isRedirect as isRedirect$1, isNotFound, createRootRoute, Outlet, ScrollRestoration, useRouter, useRouterState, RouterProvider, createMemoryHistory, ScriptOnce, isPlainObject as isPlainObject$1, encode as encode$1, createRouter as createRouter$2, pick, isPlainArray, defer as defer$1, createControlledPromise } from '@tanstack/react-router';
import x$3 from 'tiny-invariant';
import { PrismaClient } from '@prisma/client';
import { jsxs, jsx, Fragment } from 'react/jsx-runtime';
import * as h$1 from 'react';
import h__default, { createElement } from 'react';
import { Pencil, Trash } from 'lucide-react';
import { useForm } from '@tanstack/react-form';
import { ToastContainer, toast } from 'react-toastify';
import { AsyncLocalStorage } from 'node:async_hooks';
import T$1 from 'jsesc';
import { isbot } from 'isbot';
import C$1 from 'react-dom/server';
...
const appConfig$1 = {"name":"vinxi","routers":[{"name":"public","type":"static","dir":"./public","base":"/","root":"/Users/gerson.enriquez/code/myCommunityEvents","order":0,"outDir":"/Users/gerson.enriquez/code/myCommunityEvents/.vinxi/build/public"},{"name":"client","type":"client","target":"browser","handler":"app/client.tsx","base":"/_build","build":{"sourcemap":true},"root":"/Users/gerson.enriquez/code/myCommunityEvents","outDir":"/Users/gerson.enriquez/code/myCommunityEvents/.vinxi/build/client","order":1},{"name":"ssr","type":"http","target":"server","handler":"app/ssr.tsx","link":{"client":"client"},"root":"/Users/gerson.enriquez/code/myCommunityEvents","base":"/","outDir":"/Users/gerson.enriquez/code/myCommunityEvents/.vinxi/build/ssr","order":2},{"name":"server","type":"http","target":"server","base":"/_server","handler":"node_modules/@tanstack/start/dist/esm/server-handler/index.js","root":"/Users/gerson.enriquez/code/myCommunityEvents","outDir":"/Users/gerson.enriquez/code/myCommunityEvents/.vinxi/build/server","order":3}],"server":{"preset":"vercel","experimental":{"asyncContext":true}},"root":"/Users/gerson.enriquez/code/myCommunityEvents"};
				const buildManifest = {"client":{"_client-CQfkRPTm.js":{"file":"assets/client-CQfkRPTm.js","name":"client","dynamicImports":["app/routes/calendar.tsx?tsr-split","app/routes/index.tsx?tsr-split"]},"app/assets/skyline-milano.png":{"file":"assets/skyline-milano-BEzzB3lN.png","src":"app/assets/skyline-milano.png"},"app/routes/calendar.tsx?tsr-split":{"file":"assets/calendar-Ckbw-xCa.js","name":"calendar","src":"app/routes/calendar.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-CQfkRPTm.js"]},"app/routes/index.tsx?tsr-split":{"file":"assets/index-CkAnoEfI.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_client-CQfkRPTm.js"],"assets":["assets/skyline-milano-BEzzB3lN.png"]},"virtual:$vinxi/handler/client":{"file":"assets/client-CjWbXnil.js","name":"client","src":"virtual:$vinxi/handler/client","isEntry":true,"imports":["_client-CQfkRPTm.js"]}},"ssr":{"_ssr-Bpc28poy.js":{"file":"assets/ssr-Bpc28poy.js","name":"ssr","dynamicImports":["app/routes/calendar.tsx?tsr-split","app/routes/index.tsx?tsr-split"]},"app/assets/skyline-milano.png":{"file":"assets/skyline-milano-BEzzB3lN.png","src":"app/assets/skyline-milano.png"},"app/routes/calendar.tsx?tsr-split":{"file":"assets/calendar-BtuAHGOy.js","name":"calendar","src":"app/routes/calendar.tsx?tsr-split","isDynamicEntry":true},"app/routes/index.tsx?tsr-split":{"file":"assets/index-C0CpJkiP.js","name":"index","src":"app/routes/index.tsx?tsr-split","isDynamicEntry":true,"imports":["_ssr-Bpc28poy.js"],"assets":["assets/skyline-milano-BEzzB3lN.png"]},"virtual:$vinxi/handler/ssr":{"file":"ssr.js","name":"ssr","src":"virtual:$vinxi/handler/ssr","isEntry":true,"imports":["_ssr-Bpc28poy.js"]}},"server":{"_index.mjs":{"file":"index.mjs","name":"index","dynamicImports":["app/routes/index.tsx?tsr-split"]},"app/assets/skyline-milano.png":{"file":"assets/skyline-milano-BEzzB3lN.png","src":"app/assets/skyline-milano.png"},"app/routes/index.tsx":{"file":"c_11mpvlw.mjs","name":"c_11mpvlw","src":"app/routes/index.tsx","isEntry":true,"imports":["_index.mjs"]},"app/routes/index.tsx?tsr-split":{"file":"c_1n1tvvr.mjs","name":"c_1n1tvvr","src":"app/routes/index.tsx?tsr-split","isEntry":true,"isDynamicEntry":true,"imports":["_index.mjs"],"assets":["assets/skyline-milano-BEzzB3lN.png"]},"virtual:$vinxi/handler/server":{"file":"entry.mjs","name":"entry","src":"virtual:$vinxi/handler/server","isEntry":true}}};
...
function x$1(e,t,n){return Object.assign(e,{url:"https://localhost:3000"})}function g$1(e){return e instanceof Headers?new Headers(e):Array.isArray(e)?new Headers(e):typeof e=="object"?new Headers(e):new Headers}function _$1(...e){return e.reduce((t,n)=>{const r=g$1(n);for(const[a,o]of r.entries())t.set(a,o);return t},new Headers)}function l$1(e,t){const n=t||e||{};return typeof n.method>"u"&&(n.method="GET"),{options:n,middleware:r=>l$1(void 0,Object.assign(n,{middleware:r})),validator:r=>l$1(void 0,Object.assign(n,{validator:r})),handler:(...r)=>{const[a,o]=r;Object.assign(n,{...a,extractedFn:a,serverFn:o}),x$3(a.url,"createServerFn must be called with a function that is marked with the 'use server' pragma. Are you using the @tanstack/start-vite-plugin ?");const s=[...n.middleware||[],T(n)];return Object.assign(async i=>f(s,"client",{...a,method:n.method,data:i?.data,headers:i?.headers,context:Object.assign({},a)}).then(d=>d.result),{...a,__executeServer:i=>{const d=i instanceof FormData?F$2(i):i;return f(s,"server",{...a,...d}).then(c=>({result:c.result,context:c.sendContext}))}})}}}function F$2(e){const t=e.get("__TSR_CONTEXT");if(e.delete("__TSR_CONTEXT"),typeof t!="string")return {context:{},data:e};try{return {context:defaultTransformer.parse(t),data:e}}catch{return {data:e}}}function O$1(e){const t=[],n=r=>{r.forEach(a=>{a.options.middleware&&n(a.options.middleware),t.push(a);});};return n(e),t}const u=(e,t,n)=>e({data:t.data,context:t.context,sendContext:t.sendContext,method:t.method,next:r=>{const a={...t.context,...r?.context},o={...t.sendContext,...r?.sendContext??{}},s=_$1(t.headers,r?.headers);return n({method:t.method,data:t.data,context:a,sendContext:o,headers:s,result:r?.result??t.result})}});function b$2(e,t){if(e==null)return {};if("~standard"in e){const n=e["~standard"].validate(t);if("value"in n)return n.value;throw n instanceof Promise?new Error("Async validation not supported"):new Error(JSON.stringify(n.issues,void 0,2))}if("parse"in e)return e.parse(t);if(typeof e=="function")return e(t);throw new Error("Invalid validator type!")}async function f(e,t,n){const r=O$1(e),a=async o=>{const s=r.shift();if(!s)return o;s.options.validator&&(t!=="client"||s.options.validateClient)&&(o.data=await b$2(s.options.validator,o.data));const i=t==="client"?s.options.client:s.options.server;return i?u(i,o,async d=>{if(t==="client"&&s.options.clientAfter){const c=await a(d);return u(s.options.clientAfter,c,v=>v)}return a(d)}):a(o)};return a({...n,headers:n.headers||{},sendContext:n.sendContext||{},context:n.context||{}})}function T(e){return {_types:void 0,options:{validator:e.validator,validateClient:e.validateClient,client:async({next:t,sendContext:n,...r})=>{var a;const o=await((a=e.extractedFn)==null?void 0:a.call(e,{...r,context:n}));return t(o)},server:async({next:t,...n})=>{var r;const a=await((r=e.serverFn)==null?void 0:r.call(e,n));return t({result:a})}}}}const H$1=globalThis,C=H$1.prisma||new PrismaClient,E=()=>Promise.resolve().then(function () { return mod_1_3; }),M=l$1().handler(x$1(j$3),async()=>{let e=new Date;return e.setHours(0),await C.event.findMany({where:{eventDate:{gte:e}},orderBy:[{eventDate:"asc"}]})}),S$1=createFileRoute("/")({component:lazyRouteComponent(E,"component",()=>S$1.ssr)});function j$3(e){return M.__executeServer(e)}
...
const j$2=({event:n,handleDelete:o,handleEdit:i})=>jsxs("div",{style:{minWidth:"400px",maxWidth:"700px",width:"95%"},children:[jsxs("div",{style:{display:"flex",justifyContent:"end",paddingRight:"12px",marginBottom:"4px"},children:[jsx("button",{style:{borderRadius:"4px",background:"none",border:"none",color:"gray"},onClick:()=>i(n),children:jsx(Pencil,{})}),jsx("button",{style:{borderRadius:"4px",background:"none",border:"none",color:"gray"},onClick:()=>o(n.id),children:jsx(Trash,{})})]}),jsxs("div",{style:{border:"solid #582F0E",borderRadius:"8px",backgroundColor:"#FAEDCD",display:"flex",gap:"8px",alignItems:"center",boxSizing:"border-box",maxHeight:"350px",paddingRight:"32px",boxShadow:"rgba(100, 0, 0, 0.24) 0px 3px 8px",margin:"0 8px"},children:[jsx("div",{style:{minWidth:"70px",display:"flex",justifyContent:"center"},children:jsx("span",{style:{fontSize:"2rem"},children:"🗓️"})}),jsxs("div",{children:[jsx("h2",{children:jsx("a",{style:{color:"#0E577B"},href:n.eventLink,target:"_blank",rel:"noopener noreferrer",children:n.eventTitle})}),jsx("p",{style:{},children:n.eventDescription}),jsxs("div",{style:{display:"flex",justifyContent:"space-between",gap:"12px"},children:[jsx("p",{children:n.eventDate.toLocaleDateString("it-IT")}),jsx("p",{children:n.communityName})]})]})]})]}),A$1="/_server/assets/skyline-milano-BEzzB3lN.png",v$1=n=>{const o={id:n.mode==="add"?"":n.event.id,communityName:n.mode==="add"?"":n.event.communityName,eventDate:n.mode==="add"?new Date:n.event.eventDate,eventDescription:n.mode==="add"?"":n.event.eventDescription,eventLink:n.mode==="add"?"":n.event.eventLink,eventTitle:n.mode==="add"?"":n.event.eventTitle},i=useForm({defaultValues:o,onSubmit:async({value:t})=>{n.mode==="add"?n.handleAdd(t):n.handleEdit(t);}});return jsxs("div",{style:{height:"100%",display:"flex",flexDirection:"column",justifyContent:"center"},children:[jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[jsx("h2",{style:{color:"white"},children:n.mode==="add"?"Add new Event":"Edit Event"}),jsx("button",{style:{borderRadius:"4px",border:"1px solid white",background:"none",fontWeight:"600",color:"white",padding:"8px"},onClick:n.handleClose,title:"Close",children:"X"})]}),jsxs("form",{style:{display:"flex",flexDirection:"column",gap:"16px",fontSize:"1rem",color:"white"},onSubmit:t=>{t.preventDefault(),t.stopPropagation(),i.handleSubmit();},children:[jsx("div",{style:{width:"100%"},children:jsx(i.Field,{name:"communityName",children:t=>jsxs("div",{children:[jsx("label",{htmlFor:t.name,children:jsx("p",{style:{margin:"2px 0"},children:"Community Name"})}),jsx("input",{style:{width:"100%",padding:"6px 2px",borderStyle:"none",borderRadius:"2px",backgroundColor:"#DDDDDD"},name:t.name,value:t.state.value,onBlur:t.handleBlur,onChange:a=>t.handleChange(a.target.value)})]})})}),jsx("div",{style:{width:"100%"},children:jsx(i.Field,{name:"eventTitle",children:t=>jsxs(Fragment,{children:[jsx("label",{htmlFor:t.name,children:jsx("p",{style:{margin:"2px 0"},children:"Event Title"})}),jsx("input",{style:{width:"100%",padding:"6px 2px",borderStyle:"none",borderRadius:"2px",backgroundColor:"#DDDDDD"},name:t.name,value:t.state.value,onBlur:t.handleBlur,onChange:a=>t.handleChange(a.target.value)})]})})}),jsx("div",{style:{width:"100%"},children:jsx(i.Field,{name:"eventDescription",children:t=>jsxs(Fragment,{children:[jsx("label",{htmlFor:t.name,children:jsx("p",{style:{margin:"2px 0"},children:"Event Description"})}),jsx("textarea",{style:{width:"100%",padding:"6px 2px",borderStyle:"none",borderRadius:"2px",backgroundColor:"#DDDDDD"},name:t.name,rows:5,maxLength:300,value:t.state.value,onBlur:t.handleBlur,onChange:a=>t.handleChange(a.target.value)})]})})}),jsx("div",{style:{width:"100%"},children:jsx(i.Field,{name:"eventLink",children:t=>jsxs(Fragment,{children:[jsx("label",{htmlFor:t.name,children:jsx("p",{style:{margin:"2px 0"},children:"Event Link"})}),jsx("input",{style:{width:"100%",padding:"6px 2px",borderStyle:"none",borderRadius:"2px",backgroundColor:"#DDDDDD"},name:t.name,value:t.state.value,onBlur:t.handleBlur,onChange:a=>t.handleChange(a.target.value)})]})})}),jsx("div",{style:{width:"100%"},children:jsx(i.Field,{name:"eventDate",children:t=>jsxs(Fragment,{children:[jsx("label",{htmlFor:t.name,children:jsx("p",{style:{margin:"2px 0"},children:"Event Date"})}),jsx("input",{style:{width:"100%",padding:"6px 2px",borderStyle:"none",borderRadius:"2px",backgroundColor:"#DDDDDD"},name:t.name,type:"date",min:new Date().toISOString().slice(0,10),value:t.state.value.toISOString().slice(0,10),onBlur:t.handleBlur,onChange:a=>t.handleChange(new Date(a.target.value))})]})})}),jsx("div",{style:{display:"flex",justifyContent:"center"},children:jsx("button",{style:{color:"rgba(32,34,38,255)",backgroundColor:"white",borderRadius:"4px",border:"1px solid white",padding:"6px 24px",fontWeight:"600"},type:"submit",children:"Submit"})})]})]})},g=l$1({method:"POST"}).validator(n=>n).handler(x$1(I$2),async({data:n})=>await C.event.create({data:n})),x=l$1({method:"POST"}).validator(n=>n).handler(x$1(W$2),async({data:n})=>await C.event.delete({where:{id:n}})),b$1=l$1({method:"POST"}).validator(n=>n).handler(x$1(_),async({data:n})=>await C.event.update({where:{id:n.id},data:n})),q=function(){const[o,i]=h__default.useState({isOpen:!1,mode:"add"}),[t,a]=h__default.useState([]),[D,w]=h__default.useState(),f=()=>{i({isOpen:!0,mode:"add"});};h__default.useEffect(()=>{(async()=>{try{const l=await M();a(l);}catch(l){console.error(l);}})();},[]);const C=async r=>{try{await g({data:r}),a([...t,r]),i({isOpen:!1,mode:"add"}),toast("✅ Event created successfully");}catch{toast("❌ Ops.. something went wrong");}},E=async r=>{try{await b$1({data:r});const l=[...t],m=l.findIndex(k=>k.id===r.id);l[m]=r,a(l),i({isOpen:!1,mode:"add"}),toast("✅ Event updated successfully");}catch{toast("❌ Ops.. something went wrong");}},S=async r=>{if(window.confirm("Are you sure you want to delte this event?"))try{const l=t.filter(m=>m.id!==r);a(l),await x({data:r}),toast("✅ Event deleted successfully");}catch{toast("❌ Ops.. something went wrong");}};return jsxs("div",{children:[jsxs("nav",{style:{display:"flex",justifyContent:"space-between"},children:[jsx("h1",{style:{margin:"0",color:"white",fontSize:"1.3rem",fontFamily:"cursive"},children:"My Community Events"}),jsx("button",{style:{color:"white",backgroundColor:"rgba(32,34,38,255)",borderRadius:"4px",border:"1px solid white",boxShadow:"rgba(255, 255, 255, 50) 1px 1px 2px 0px",padding:"4px 12px"},onClick:f,children:jsx("span",{children:"Add Event"})})]}),o.isOpen&&jsx("div",{style:{position:"fixed",top:0,left:0,height:"100%",width:"100%",backgroundColor:"rgba(0,0,0, 0.8)"},children:jsx("dialog",{style:{backgroundColor:"rgba(32,34,38,255)",border:"solid gray",borderRadius:"8px",width:"80%",maxWidth:"600px",minWidth:"250px",position:"absolute",top:"20%"},open:o.isOpen,children:o.mode==="add"?jsx(v$1,{mode:"add",handleAdd:C,handleClose:()=>i({isOpen:!1,mode:"add"})}):jsx(v$1,{mode:"edit",handleEdit:E,handleClose:()=>i({isOpen:!1,mode:"add"}),event:D??{}})})}),jsx("div",{style:{display:"flex",justifyContent:"center"},children:jsx("div",{style:{maxWidth:"700px"},children:jsx("img",{style:{margin:"auto",width:"100%"},src:A$1})})}),jsxs("div",{style:{display:"flex",justifyContent:"center"},children:[jsx("div",{style:{display:"flex",flexDirection:"column",justifyContent:"center",alignContent:"center",alignItems:"center",gap:"40px"},children:t.map(r=>jsx(j$2,{event:r,handleDelete:S,handleEdit:()=>{i({isOpen:!0,mode:"edit"}),w(r);}},r.id))}),jsx(ToastContainer,{theme:"dark",autoClose:3e3})]})]})};function I$2(n){return g.__executeServer(n)}function W$2(n){return x.__executeServer(n)}function _(n){return b$1.__executeServer(n)}
...
const chunks = {};
				chunks['c_11mpvlw.mjs'] = mod_0_3;
				chunks['c_1n1tvvr.mjs'] = mod_1_3;
...
function F$1(e){let n;const t=R(e),s={duplex:"half",method:e.method,headers:e.headers};return e.node.req.body instanceof ArrayBuffer?new Request(t,{...s,body:e.node.req.body}):new Request(t,{...s,get body(){return n||(n=W$1(e),n)}})}function L$1(e){return e.web??={request:F$1(e),url:R(e)},e.web.request}function H(){return S()}const w=Symbol("$HTTPEvent");function O(e){return typeof e=="object"&&(e instanceof H3Event||e?.[w]instanceof H3Event||e?.__is_event__===!0)}function l(e){return function(...n){let t=n[0];if(O(t))n[0]=t instanceof H3Event||t.__is_event__?t:t[w];else {if(!globalThis.app.config.server.experimental?.asyncContext)throw new Error("AsyncLocalStorage was not enabled. Use the `server.experimental.asyncContext: true` option in your app configuration to enable it. Or, pass the instance of HTTPEvent that you have as the first argument to the function.");if(t=H(),!t)throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");n.unshift(t);}return e(...n)}}const R=l(getRequestURL),P$1=l(getResponseStatus),W$1=l(getRequestWebStream);function I$1(){return getContext("nitro-app",{asyncContext:!!globalThis.app.config.server.experimental?.asyncContext,AsyncLocalStorage:AsyncLocalStorage})}function S(){return I$1().use().event}function U$1(e){return globalThis.MANIFEST[e]}const G=eventHandler(j$1);async function j$1(e){return J(L$1(e))}async function J(e,n){var t,s;const p=e.method,T=new URL(e.url,"http://localhost:3000"),a=Object.fromEntries(T.searchParams.entries()),i=a._serverFnId,d=a._serverFnName;if(!i||!d)throw new Error("Invalid request");x$3(typeof i=="string","Invalid server action");const b=(s=await((t=U$1("server").chunks[i])==null?void 0:t.import()))==null?void 0:s[d],u=await(async()=>{try{const r=await(async()=>{var y;if((y=e.headers.get("Content-Type"))!=null&&y.includes("multipart/form-data"))return x$3(p.toLowerCase()!=="get","GET requests with FormData payloads are not supported"),await e.formData();if(p.toLowerCase()==="get")return a.payload?defaultTransformer.parse(a.payload):void 0;const x=await e.text();return defaultTransformer.parse(x)})(),o=await b(r);return o instanceof Response?o:isRedirect$1(o)||isNotFound(o)?v(o):new Response(o!==void 0?defaultTransformer.stringify(o):void 0,{status:P$1(S()),headers:{"Content-Type":"application/json"}})}catch(r){return r instanceof Response?r:isRedirect$1(r)||isNotFound(r)?v(r):(console.error("Server Fn Error!"),console.error(r),console.info(),new Response(JSON.stringify(r),{status:500,headers:{"Content-Type":"application/json"}}))}})();if(u.headers.get("Content-Type")==="application/json"){const o=await u.clone().text();o&&JSON.stringify(JSON.parse(o));}return u}function v(e){const{headers:n,...t}=e;return new Response(JSON.stringify(t),{status:200,headers:{"Content-Type":"application/json",...e.headers||{}}})}
  ...
  return j(r, (s, a) => {
    ...
    if (i) {
      ...
      if (n.push(c), i === "stream") {
        const [u, l] = s.tee();
        return c.streamState = je({ stream: l }), u;
      } else defer$1(s);
    }
    return s;
  });
...
function He(e) {
  ...
  const n = t.extracted, [o, s] = ["__beforeLoadContext", "loaderData"].map((a) => n ? n.reduce((i, c) => c.dataType !== a ? P(i, ["temp", ...c.path], void 0) : i, { temp: t[a] }).temp : t[a]);
  if (o !== void 0 || s !== void 0 || (n == null ? void 0 : n.length)) {
    const a = `__TSR__.initMatch(${T$1({ index: e.matchIndex, __beforeLoadContext: r.options.transformer.stringify(o), loaderData: r.options.transformer.stringify(s), extracted: n ? Object.fromEntries(n.map((i) => [i.id, pick(i, ["type", "path"])])) : {} }, { isScriptContext: true, wrap: true, json: true })})`;
    return jsxs(Fragment, { children: [jsx(ScriptOnce, { children: a }), n ? n.map((i) => i.type === "stream" ? jsx($e, { entry: i }, i.id) : jsx(Oe, { entry: i }, i.id)) : null] });
  }
  return null;
}
function j(e, r, t = []) {
  if (isPlainArray(e)) return e.map((o, s) => j(o, r, [...t, `${s}`]));
  if (isPlainObject$1(e)) {
    const o = {};
    for (const s in e) o[s] = j(e[s], r, [...t, s]);
    return o;
  }
  const n = r(e, t);
  return n !== e ? n : e;
...
function Oe({ entry: e }) {
  return jsx("div", { className: "tsr-once", children: jsx(h$1.Suspense, { fallback: null, children: jsx(Me, { entry: e }) }) });
}
function Me({ entry: e }) {
  const r = useRouter();
  if (e.value.status === "pending") throw e.value;
  const t = `__TSR__.resolvePromise(${T$1(e, { isScriptContext: true, wrap: true, json: true })})`;
  return r.injectScript(t), jsx(Fragment, {});
}
function $e({ entry: e }) {
  x$3(e.streamState, "StreamState should be defined");
  const r = useRouter();
  return jsx(V, { streamState: e.streamState, children: (t) => {
    const n = t ? `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.enqueue(new TextEncoder().encode(${T$1(t.toString(), { isScriptContext: true, wrap: true, json: true })}))` : `__TSR__.matches[${e.matchIndex}].extracted[${e.id}].value.controller.close()`;
    return r.injectScript(n), jsx(Fragment, {});
  } });
}
function je({ stream: e }) {
...
function V({ streamState: e, children: r, __index: t = 0 }) {
  const n = e.promises[t];
  if (!n) return null;
  if (n.status === "pending") throw n;
  const o = n.value;
  return jsxs(Fragment, { children: [r(o), jsx("div", { className: "tsr-once", children: jsx(h$1.Suspense, { fallback: null, children: jsx(V, { streamState: e, __index: t + 1, children: r }) }) })] });
}
function P(e, r, t) {
  if (r.length === 0) return t;
  const [n, ...o] = r;
  return Array.isArray(e) ? e.map((s, a) => a === Number(n) ? P(s, o, t) : s) : isPlainObject$1(e) ? { ...e, [n]: P(e[n], o, t) } : e;
}
function L(e) {
  e.router.AfterEachMatch = He, e.router.serializer = (n) => T$1(n, { isScriptContext: true, wrap: true, json: true });
  const r = Context.get("TanStackRouterHydrationContext", {}), t = h$1.useMemo(() => {
    var n, o;
...
function Pe(e) {
  let r;
  const t = Y(e), n = { duplex: "half", method: e.method, headers: e.headers };
...
function Z(e) {
  var _a;
  return (_a = e.web) != null ? _a : e.web = { request: Pe(e), url: Y(e) }, e.web.request;
}
function Fe() {
  return A();
}
...
function b(e) {
  return function(...r) {
    var _a;
    let t = r[0];
    if (Ie(t)) r[0] = t instanceof H3Event || t.__is_event__ ? t : t[K];
    else {
      if (!((_a = globalThis.app.config.server.experimental) == null ? void 0 : _a.asyncContext)) throw new Error("AsyncLocalStorage was not enabled. Use the `server.experimental.asyncContext: true` option in your app configuration to enable it. Or, pass the instance of HTTPEvent that you have as the first argument to the function.");
      if (t = Fe(), !t) throw new Error("No HTTPEvent found in AsyncLocalStorage. Make sure you are using the function within the server runtime.");
      r.unshift(t);
    }
    return e(...r);
  };
}
const qe = b(getRequestHeaders), Y = b(getRequestURL), Ae = b(getResponseStatus), ke = b(getResponseHeaders), Ne = b(getRequestWebStream);
function Le() {
  var _a;
...
function Be({ createRouter: e, getRouterManifest: r }) {
  return (t) => eventHandler(async (n) => {
    const o = Z(n), s = new URL(o.url), a = s.href.replace(s.origin, ""), i = createMemoryHistory({ initialEntries: [a] }), c = e();
    c.serializeLoaderData = Ce, r && (c.manifest = r()), c.update({ history: i }), await c.load();
    const u = We({ event: n, router: c });
    return await t({ request: o, router: c, responseHeaders: u });
  });
}
function We(e) {
  e.event.__tsrHeadersSent = true;
  let r = F(ke(e.event), { "Content-Type": "text/html; charset=UTF-8" }, ...e.router.state.matches.map((n) => n.headers));
  const { redirect: t } = e.router.state;
  return t && (r = F(r, t.headers, { Location: t.href })), r;
}
function Ue(e) {
  const r = ee(() => e.injectedHtml.map((t) => t()).join(""));
...
function Je(e) {
  const r = ee(() => e.injectedHtml.map((n) => n()).join("")), t = new TextEncoder();
...
const ze = /(<body)/, Ge = /(<\/body>)/, Qe = /(<\/html>)/, Xe = /(<\/[a-zA-Z][\w:.-]*?>)/g, Ve = new TextDecoder();
function ee(e) {
  let r = false, t = "", n = "";
  return { async transform(o, s) {
    const a = t + Ve.decode(o), i = a.match(ze), c = a.match(Ge), u = a.match(Qe);
    try {
      if (i && (r = true), !r) {
        s(a), t = "";
        return;
      ...
      const l = e();
      if (c && u && c.index < u.index) {
        const f = c.index + c[0].length, p = u.index + u[0].length, h = a.slice(0, f) + l + a.slice(f, p) + a.slice(p);
        s(h), t = "";
      } else {
        let f, p = 0;
        for (; (f = Xe.exec(a)) !== null; ) p = f.index + f[0].length;
        if (p > 0) {
          const h = a.slice(0, p) + l + n;
          s(h), t = a.slice(p);
        } else t = a, n += l;
      }
    } catch (l) {
      throw console.error("Error transforming HTML:", l), l;
    }
  }, async flush(o) {
    t && o(t);
  } };
...
const Ze = async ({ request: e, router: r, responseHeaders: t }) => {
  if (typeof C$1.renderToReadableStream == "function") {
    const n = await C$1.renderToReadableStream(jsx(L, { router: r }), { signal: e.signal });
    isbot(e.headers.get("User-Agent")) && await n.allReady;
    const s = [Je(r)].reduce((a, i) => a.pipeThrough(i), n);
    return new Response(s, { status: r.state.statusCode, headers: t });
  }
  if (typeof C$1.renderToPipeableStream == "function") {
    const n = new PassThrough(), o = C$1.renderToPipeableStream(jsx(L, { router: r }), { ...isbot(e.headers.get("User-Agent")) ? { onAllReady() {
      o.pipe(n);
    } } : { onShellReady() {
      o.pipe(n);
    } }, onError: (i, c) => {
      console.log("Error in renderToPipeableStream:", i, c);
    } }), a = [Ue(r)].reduce((i, c) => i.pipe(c), n);
    return new Response(a, { status: r.state.statusCode, headers: t });
  }
  throw new Error("No renderToReadableStream or renderToPipeableStream found in react-dom/server. Ensure you are using a version of react-dom that supports streaming.");
}, Ke = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/", "/calendar"], preloads: ["/_build/assets/client-CjWbXnil.js", "/_build/assets/client-CQfkRPTm.js"] }, "/": { filePath: "index.tsx" }, "/calendar": { filePath: "calendar.tsx" } } });
function te(e) {
  return globalThis.MANIFEST[e];
}
function Ye() {
  var _a;
  const e = Ke(), r = e.routes.__root__ = e.routes.__root__ || {};
  r.assets = r.assets || [];
  const t = te("client");
...
function re({ tag: e, attrs: r, children: t }) {
  switch (e) {
    case "title":
...
function I(e, r) {
  const t = r || e || {};
  return typeof t.method > "u" && (t.method = "GET"), { options: t, middleware: (n) => I(void 0, Object.assign(t, { middleware: n })), validator: (n) => I(void 0, Object.assign(t, { validator: n })), handler: (...n) => {
    const [o, s] = n;
    Object.assign(t, { ...o, extractedFn: o, serverFn: s }), x$3(o.url, "createServerFn must be called with a function that is marked with the 'use server' pragma. Are you using the @tanstack/start-vite-plugin ?");
    const a = [...t.middleware || [], ot(t)];
    return Object.assign(async (i) => B(a, "client", { ...o, method: t.method, data: i == null ? void 0 : i.data, headers: i == null ? void 0 : i.headers, context: Object.assign({}, o) }).then((c) => c.result), { ...o, __executeServer: (i) => {
      const c = i instanceof FormData ? tt(i) : i;
      return B(a, "server", { ...o, ...c }).then((u) => ({ result: u.result, context: u.sendContext }));
    } });
  } };
}
function tt(e) {
  ...
  try {
    return { context: defaultTransformer.parse(r), data: e };
  } catch {
    return { data: e };
  }
}
function rt(e) {
  const r = [], t = (n) => {
    n.forEach((o) => {
      o.options.middleware && t(o.options.middleware), r.push(o);
    });
  };
  return t(e), r;
}
const D = (e, r, t) => e({ data: r.data, context: r.context, sendContext: r.sendContext, method: r.method, next: (n) => {
  var _a, _b;
  const o = { ...r.context, ...n == null ? void 0 : n.context }, s = { ...r.sendContext, ...(_a = n == null ? void 0 : n.sendContext) != null ? _a : {} }, a = F(r.headers, n == null ? void 0 : n.headers);
  return t({ method: r.method, data: r.data, context: o, sendContext: s, headers: a, result: (_b = n == null ? void 0 : n.result) != null ? _b : r.result });
} });
function nt(e, r) {
  if (e == null) return {};
  if ("~standard" in e) {
...
async function B(e, r, t) {
  const n = rt(e), o = async (s) => {
    const a = n.shift();
    if (!a) return s;
    a.options.validator && (r !== "client" || a.options.validateClient) && (s.data = await nt(a.options.validator, s.data));
    const i = r === "client" ? a.options.client : a.options.server;
    return i ? D(i, s, async (c) => {
      if (r === "client" && a.options.clientAfter) {
        const u = await o(c);
        return D(a.options.clientAfter, u, (l) => l);
      }
      return o(c);
    }) : o(s);
  };
...
const st = () => {
  const e = useRouter(), r = useRouterState({ select: (s) => s.matches.map((a) => a.meta).filter(Boolean) }), t = h$1.useMemo(() => {
    const s = [], a = {};
    let i;
    return [...r].reverse().forEach((c) => {
      [...c].reverse().forEach((u) => {
        if (u) if (u.title) i || (i = { tag: "title", children: u.title });
        else {
          if (u.name) {
            if (a[u.name]) return;
            a[u.name] = true;
          }
          s.push({ tag: "meta", attrs: { ...u } });
        }
      });
    ...
    return s.matches.map((i) => e.looseRoutesById[i.routeId]).forEach((i) => {
      var c, u, l;
      return (l = (u = (c = e.manifest) == null ? void 0 : c.routes[i.id]) == null ? void 0 : u.preloads) == null ? void 0 : l.filter(Boolean).forEach((f) => {
        a.push({ tag: "link", attrs: { rel: "modulepreload", href: f } });
      });
    }), a;
  }, structuralSharing: true });
  return ct([...t, ...o, ...n], (s) => JSON.stringify(s));
}, at = () => {
  const e = useRouter(), r = st(), t = h$1.useContext(Context.get("TanStackRouterHydrationContext", {}));
  return jsxs(Fragment, { children: [r.map((n, o) => createElement(re, { ...n, key: `tsr-meta-${JSON.stringify(n)}` })), jsxs(Fragment, { children: [jsx(ScriptOnce, { log: false, children: '__TSR__={matches:[],streamedValues:{},queue:[],runQueue:()=>{let e=!1;__TSR__.queue=__TSR__.queue.filter((_=>!_()||(e=!0,!1))),e&&__TSR__.runQueue()},initMatch:e=>{__TSR__.queue.push((()=>(__TSR__.matches[e.index]||(__TSR__.matches[e.index]=e,Object.entries(e.extracted).forEach((([e,_])=>{if("stream"===_.type){let e;_.value=new ReadableStream({start(_){e=_}}),_.value.controller=e}else if("promise"===_.type){let e,t;_.value=new Promise(((_,u)=>{e=_,t=u})),_.resolve=e,_.reject=t}}))),!0))),__TSR__.runQueue()},resolvePromise:e=>{__TSR__.queue.push((()=>{const _=__TSR__.matches[e.matchIndex];if(_){const t=_.extracted[e.id];if(t)return t.resolve(e.value.data),!0}return!1})),__TSR__.runQueue()},cleanScripts:()=>{document.querySelectorAll(".tsr-once").forEach((e=>{e.remove()}))}};' }), jsx(ScriptOnce, { children: `__TSR__.dehydrated = ${T$1(e.options.transformer.stringify(t), { isScriptContext: true, wrap: true, json: true })}` })] })] });
}, it = () => jsx(Fragment, { children: at() });
function ct(e, r) {
...
const ut = () => {
  const e = useRouter(), r = useRouterState({ select: (o) => {
    ...
    return o.matches.map((a) => e.looseRoutesById[a.routeId]).forEach((a) => {
      var i, c, u;
      return (u = (c = (i = e.manifest) == null ? void 0 : i.routes[a.id]) == null ? void 0 : c.assets) == null ? void 0 : u.filter((l) => l.tag === "script").forEach((l) => {
        s.push({ tag: "script", attrs: l.attrs, children: l.children });
      });
    }), s;
  ...
  return jsx(Fragment, { children: n.map((o, s) => createElement(re, { ...o, key: `tsr-scripts-${o.tag}-${s}` })) });
}, k = createRootRoute({ head: () => ({ meta: [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, { title: "Community Events" }] }), component: dt });
function dt() {
  return jsx(lt, { children: jsx(Outlet, {}) });
}
function lt({ children: e }) {
  return jsxs("html", { children: [jsx("head", { children: jsx(it, {}) }), jsxs("body", { style: { backgroundColor: "rgba(32,34,38,255)", fontFamily: "Gill Sans", maxWidth: "700px", margin: "auto", padding: "12px 8px" }, children: [e, jsx(ScrollRestoration, {}), jsx(ut, {})] })] });
}
const ft = () => import('../build/calendar-BtuAHGOy.mjs'), ne = createFileRoute("/calendar")({ component: lazyRouteComponent(ft, "component", () => ne.ssr) });
async function pt(e, r, t) {
  var n;
  const o = r[0];
  if (isPlainObject$1(o) && o.method) {
    const u = o, l = u.data instanceof FormData ? "formData" : "payload", f = new Headers({ ...l === "payload" ? { "content-type": "application/json", accept: "application/json" } : {}, ...u.headers instanceof Headers ? Object.fromEntries(u.headers.entries()) : u.headers || {} });
    if (u.method === "GET") {
      const S = encode$1({ payload: defaultTransformer.stringify({ data: u.data, context: u.context }) });
      S && (e += `&${S}`);
    }
    const p = new Request(e, { method: u.method, headers: f, ...ht(u) }), h = await t(p), v = await W(h);
    if ((n = v.headers.get("content-type")) != null && n.includes("application/json")) {
      const S = await v.text(), E = S ? defaultTransformer.parse(S) : void 0;
      if (isRedirect$1(E) || isNotFound(E)) throw E;
      return E;
    }
    return v;
  }
  const s = new Request(e, { method: "POST", headers: { Accept: "application/json", "Content-Type": "application/json" }, body: JSON.stringify(r) }), a = await W(await t(s)), i = a.headers.get("content-type"), c = await a.text();
  return i && i.includes("application/json") ? c ? JSON.parse(c) : void 0 : c;
}
function ht(e) {
  var _a;
...
async function W(e) {
  if (!e.ok) {
    const r = e.headers.get("content-type"), t = r && r.includes("application/json"), n = await (async () => t ? await e.json() : await e.text())(), o = `Request failed with status ${e.status}`;
    throw t ? new Error(JSON.stringify({ message: o, body: n })) : new Error([o, `${JSON.stringify(n, null, 2)}`].join(`
...
async function oe(e, r) {
  var t, n;
  const o = e.method, s = new URL(e.url, "http://localhost:3000"), a = Object.fromEntries(s.searchParams.entries()), i = a._serverFnId, c = a._serverFnName;
  if (!i || !c) throw new Error("Invalid request");
  x$3(typeof i == "string", "Invalid server action");
  const u = (n = await ((t = te("server").chunks[i]) == null ? void 0 : t.import())) == null ? void 0 : n[c], l = await (async () => {
    try {
      const f = await (async () => {
        var h;
        if ((h = e.headers.get("Content-Type")) != null && h.includes("multipart/form-data")) return x$3(o.toLowerCase() !== "get", "GET requests with FormData payloads are not supported"), await e.formData();
        if (o.toLowerCase() === "get") return a.payload ? defaultTransformer.parse(a.payload) : void 0;
        const v = await e.text();
        return defaultTransformer.parse(v);
      })(), p = await u(f);
      return p instanceof Response ? p : isRedirect$1(p) || isNotFound(p) ? U(p) : new Response(p !== void 0 ? defaultTransformer.stringify(p) : void 0, { status: Ae(A()), headers: { "Content-Type": "application/json" } });
    } catch (f) {
      return f instanceof Response ? f : isRedirect$1(f) || isNotFound(f) ? U(f) : (console.error("Server Fn Error!"), console.error(f), console.info(), new Response(JSON.stringify(f), { status: 500, headers: { "Content-Type": "application/json" } }));
    }
  })();
  if (l.headers.get("Content-Type") === "application/json") {
    const p = await l.clone().text();
...
function _t(e, r, t) {
  const n = mt("http://localhost:3000", r, t);
  return Object.assign((...s) => (x$3(s.length === 1, "Server functions can only accept a single argument"), pt(n, s, async (a) => {
    const i = A(), c = qe(i);
    return Object.entries(c).forEach(([u, l]) => {
      a.headers.has(u) || a.headers.append(u, l);
    }), oe(a);
  })), { url: n, filename: r, functionId: t });
}
const gt = globalThis, vt = gt.prisma || new PrismaClient(), St = () => import('../build/index-C0CpJkiP.mjs'), wt = I().handler(_t(xt, "c_11mpvlw", "$$function0"), async () => {
  let e = /* @__PURE__ */ new Date();
  return e.setHours(0), await vt.event.findMany({ where: { eventDate: { gte: e } }, orderBy: [{ eventDate: "asc" }] });
}), se = createFileRoute("/")({ component: lazyRouteComponent(St, "component", () => se.ssr) });
function xt(e) {
  return wt.__executeServer(e);
}
const Rt = ne.update({ id: "/calendar", path: "/calendar", getParentRoute: () => k }), Tt = se.update({ id: "/", path: "/", getParentRoute: () => k }), bt = { IndexRoute: Tt, CalendarRoute: Rt }, Et = k._addFileChildren(bt)._addFileTypes();
function Ct() {
  return createRouter$2({ routeTree: Et });
}
const Dt = Be({ createRouter: Ct, getRouterManifest: et })(Ze);

const handlers = [
  { route: '/_server', handler: G, lazy: false, middleware: true, method: undefined },
  { route: '/', handler: Dt, lazy: false, middleware: true, method: undefined }
];
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/Users/gerson.enriquez/code/myCommunityEvents/.data/kv"}));
...
export { I, _t as _, listener as l, node$1 as n, vt as v, wt as w };
